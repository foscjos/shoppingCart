...
exports.callSubmitOrder = exports.watchSubmitOrder = exports.stateSelector = void 0;
var effects_1 = require("redux-saga/effects");
var order_action_1 = require("../Actions/order-action");
var stateSelector = function (state) { return state; };
exports.stateSelector = stateSelector;
function watchSubmitOrder() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest('SUBMIT_ORDER', callSubmitOrder)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.watchSubmitOrder = watchSubmitOrder;
function callSubmitOrder() {
    var state, orderInfo, request;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.select(exports.stateSelector)];
            case 1:
                state = _a.sent();
                orderInfo = {
                ...
                request = {
                    ...
                    body: JSON.stringify({ orderInfo: orderInfo, cart: state.shoppingCart.items })
                };
                return [4 /*yield*/, fetch('create/Order', request)];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.put(order_action_1.submitOrderSuccess())];
            case 3:
                _a.sent();
...
exports.callSubmitOrder = callSubmitOrder;
//# sourceMappingURL=order-saga.js.map